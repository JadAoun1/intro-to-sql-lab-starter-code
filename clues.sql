...
WHERE C.name = 'Vatican City' AND L.IsOfficial = TRUE;
...
AND C.code NOT IN (SELECT countrycode FROM countrylanguage WHERE language != 'Italian')
AND C.region = 'Southern Europe'
AND C.name != 'Vatican City'; -- Exclude Vatican City itself
